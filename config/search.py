...
search_terms = ["React Native Developer", "React Developer", "Software Engineer", "Sr. Software Engineer", "Technical Delivery Manager", "Technical Project Manager", "Software Developer", "Front End Developer", "Full Stack Developer", "Web Developer", "Nodejs Developer"]
...
bad_words = ["Java", "No C2C", "No Corp2Corp", ".NET", "Embedded Programming", "PHP", "Ruby", "CNC"]                     # (dynamic multiple search) or leave empty as []. Case Insensitive. Ex: ["word_1", "phrase 1", "word word", "polygraph", "US Citizenship", "Security Clearance"]
