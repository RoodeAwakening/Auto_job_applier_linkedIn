...
# Your legal name
first_name = "Derek"                 # Your first name in quotes Eg: "First", "Sai"
middle_name = "I"            # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Roode"                # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "4402254172"        # Enter your 10 digit number in quotes Eg: "9876543210"

# What is your current city?
current_city = "Cleveland"                  # Los Angeles, San Francisco, etc.
'''
